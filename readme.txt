...
* Whether to position the indicator in the top/bottom, left/right.
...
1. The default appearance
2. The main settings
3. The position settings
4. The graphical settings
5. The hide on mobile settings
...
Update through the automatic WordPress updater, all content and configuration will remain in place.
